...
test_feature_vector = test_feature.reshape(len(test_feature),28,28,1).astype('uint8')
test_feature_normalize = test_feature_vector
model_name='quantized_pruned_model.tflite'
